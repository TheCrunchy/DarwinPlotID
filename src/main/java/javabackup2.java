...
//	    HashMap<String, Calendar> plottimeupdate = new HashMap<>();
//	    
...
//	    	System.out.println("TP event for plotid bar");
...
//    	
//		    				}
//		    		//	System.out.println("removed old bars, clearly it fucking didnt though");
...
//				for (Entry<String, Calendar> entry : plottimeupdate.entrySet()) {
//				    String key = entry.getKey();
//				    Calendar value = entry.getValue();
//				    tasktime.add(Calendar.MILLISECOND, -1);
//				   // System.out.println("Dunno what the fuck im doing tbh");
//				    if (plottimeupdate.get(key) == tasktime);
//				    {
...
//        	    	            .name("send message task").submit(plugin);
//	    				Calendar calendar = Calendar.getInstance();
//	    				plottimeupdate.put(player.getName(), calendar);
